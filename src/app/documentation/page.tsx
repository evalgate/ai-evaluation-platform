...
const docSections = [
	...
	},
	{
		...
		description: "Connect your applications and services",
		links: [
			{ label: "API Reference", href: "/api-reference" },
			{ label: "API Contract", href: "/docs/api-contract" },
			{ label: "Integration Reference", href: "/docs/integration-reference" },
	...
	},
	{
		...
		links: [
			...
			{ label: "Agent Governance", href: "/docs/agent-governance" },
		],
	},
	{
		icon: Users,
					...
					<Card className="p-6 sm:p-8 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-blue-500/20">
						<div className="text-center">
							...
							<p className="text-base sm:text-lg text-muted-foreground mb-4 sm:mb-6 max-w-2xl mx-auto">
								Complete API documentation with code examples and interactive
								endpoints
							</p>
