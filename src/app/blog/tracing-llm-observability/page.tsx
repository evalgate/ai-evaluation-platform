        ...
        <article>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none text-sm sm:text-base">
            <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
              Why distributed tracing matters for AI applications and what metrics you should be
              tracking to understand and optimize your LLM systems.
            </p>

            <h2 className="text-2xl font-bold mb-4 mt-8">The Observability Gap</h2>
            <p className="text-muted-foreground mb-4">
              Traditional observability tools were built for deterministic systems: API latency,
              error rates, database queries. These metrics still matter for AI applications, but
              they don't tell you what you really need to know:
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              You need tracing—the ability to follow a request through your entire AI pipeline and
              understand what happened at each step.
            </p>

            <h2 className="text-2xl font-bold mb-4 mt-8">What is LLM Tracing?</h2>
            <p className="text-muted-foreground mb-4">
              Tracing captures the full execution path of an AI request as a tree of
              "spans"—individual operations that make up the larger workflow. For an AI application,
...
└─ ✅ Total: 3,002ms, $0.042 cost`}
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              ...
              <li>
                <strong>Inputs/outputs:</strong> Prompts, completions, retrieved documents
              </li>
              <li>
                <strong>Metadata:</strong> Model name, temperature, token counts
              </li>
              <li>
                <strong>Cost:</strong> Token usage translated to actual dollars spent
              </li>
            </ul>
            ...
            <p className="text-muted-foreground mb-4">
              When a user reports "the AI gave me a wrong answer," what do you do? Without tracing,
              you're guessing. With tracing, you can:
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
            ...
            <p className="text-muted-foreground mb-4">
              LLM costs scale with usage, and tokens add up fast. Tracing shows you exactly where
            ...
            <div className="rounded-lg border border-border bg-card p-4 mb-4">
              ...
              <p className="text-sm text-muted-foreground">
                A team noticed their LLM costs doubled overnight. Tracing revealed a code change
                accidentally included the entire conversation history in every request. Average
                prompt size went from 400 tokens to 2,100 tokens. One line fix saved $15K/month.
              </p>
            </div>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              <li>
                <strong>End-to-end latency:</strong> Total time from request to response
              </li>
              <li>
                <strong>LLM latency:</strong> Just the model inference time
              </li>
              <li>
                <strong>Time to first token (TTFT):</strong> For streaming responses
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              ...
              <li>
                <strong>Cost per user/session:</strong> Aggregate spending patterns
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              <li>
                <strong>Retrieval relevance:</strong> Are we finding the right documents?
              </li>
              <li>
                <strong>Context utilization:</strong> Is the LLM using provided context?
              </li>
              <li>
                <strong>Output diversity:</strong> Are responses varied or repetitive?
              </li>
              <li>
                <strong>Error rates:</strong> API failures, timeouts, rate limits
              </li>
            </ul>
...
const response = await trace.llm({
  ...
  metadata: { temperature: 0.7, user_id }
            ...
            <p className="text-muted-foreground mb-4">Track what documents are fetched and why:</p>
            <div className="rounded-lg border border-border bg-card p-4 mb-4">
              <code className="text-sm">
  ...
  return response
            ...
            <div className="space-y-6 mb-6">
              <div className="rounded-lg border border-border bg-card p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Identify requests with abnormally high token counts. Found that certain user
                  questions triggered expensive multi-turn conversations. Added smarter conversation
                  pruning, reduced costs by 35%.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-card p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Discovered that vector search was taking 400ms while LLM call took 2s. Moved to
                  parallel retrieval and reduced end-to-end latency by 25%.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-card p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Users reported "AI doesn't know about recent features." Traces showed retrieval
                  was working, but LLM was ignoring recent docs in favor of general knowledge. Added
                  recency weighting to fix.
                </p>
              </div>
            </div>
            ...
            <ol className="list-decimal pl-6 text-muted-foreground space-y-2 mb-4">
              <li>
                <strong>Trace everything in production:</strong> You can't debug what you don't
                capture
              </li>
              <li>
                <strong>Include user context:</strong> User ID, session ID, feature flags help with
                filtering
              </li>
              <li>
                <strong>Set up alerts:</strong> Notify when latency, cost, or error rates spike
              </li>
              <li>
                <strong>Sample intelligently:</strong> Trace 100% of errors and slow requests,
                sample the rest
              </li>
              <li>
                <strong>Link traces to evaluation:</strong> Use trace IDs to pull production
                examples into test sets
              </li>
              <li>
                <strong>Build dashboards:</strong> Monitor trends over time, not just individual
                traces
              </li>
            </ol>
            ...
            <p className="text-muted-foreground mb-4">
              You'll immediately see patterns and opportunities for optimization that were invisible
              before.
            </p>
            ...
            <div className="rounded-lg border border-border bg-card p-6 mt-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Our platform provides automatic tracing for all major LLM providers. Get started
                with our tracing setup guide.
              </p>
              <Button asChild>
