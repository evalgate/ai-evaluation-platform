        ...
        <article>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
              How to design evaluation criteria that capture quality, relevance, and safety in AI
              outputs. Real examples from production systems.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              An LLM judge is a strong language model (like GPT-4 or Claude-3.5) that evaluates
              outputs from your production model. Think of it as an automated code reviewer, but for
              natural language.
            </p>
            <p className="text-muted-foreground mb-4">
              The key to effective LLM judging is the rubric—a clear, detailed specification of what
              "good" looks like for your use case. A well-designed rubric can achieve 85-95%
              agreement with human experts while being 100x faster and cheaper.
            </p>

            <h2 className="text-2xl font-bold mb-4 mt-8">Anatomy of a Good Rubric</h2>
            <p className="text-muted-foreground mb-4">Effective rubrics have three components:</p>

            <h3 className="text-xl font-semibold mb-3 mt-6">1. Clear Evaluation Criteria</h3>
            <p className="text-muted-foreground mb-4">
              Define specific, measurable dimensions of quality. Avoid vague terms like "good" or
              "natural."
            </p>
            <div className="rounded-lg border border-border bg-card p-4 mb-4">
              ...
              <p className="text-sm">
                <strong>✅ Good:</strong> "Does the response directly answer the user's question
            ...
            <p className="text-muted-foreground mb-4">
              Show examples of excellent, acceptable, and unacceptable outputs. This calibrates the
              judge's standards.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6">3. Scoring Guidelines</h3>
            <p className="text-muted-foreground mb-4">
              Specify how to translate qualitative assessment into quantitative scores (1-5 scale,
              pass/fail, etc.)
            </p>
              ...
              <div className="text-sm space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                    ...
                    <li>
                      <strong>3:</strong> Mostly correct but missing some details
                    </li>
                    <li>
                      <strong>1:</strong> Contains factual errors or outdated information
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                    <li>
                      <strong>5:</strong> Fully resolves the user's issue with clear next steps
                    </li>
                    <li>
                      <strong>3:</strong> Points in the right direction but lacks detail
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                    <li>
                      <strong>Pass:</strong> Professional, empathetic, avoids jargon
                    </li>
                    <li>
                      <strong>Fail:</strong> Rude, dismissive, overly technical, or unprofessional
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="rounded-lg border border-border bg-card p-4 mb-4">
              <code className="text-sm">
                ...
                uses 'we' not 'I', avoids corporate jargon. Provide specific examples of where it
                succeeds or fails."
              </code>
            </div>
            ...
            <ol className="list-decimal pl-6 text-muted-foreground space-y-3 mb-4">
              <li>
                <strong>Start with human labels:</strong> Have experts review 50-100 outputs and
                note what makes them good or bad. This reveals what dimensions matter.
              </li>
              <li>
                <strong>Test inter-rater reliability:</strong> Run the same inputs through your LLM
                judge multiple times. High variance means your rubric is ambiguous.
              </li>
              <li>
                <strong>Compare to human judgment:</strong> Calculate agreement rates between LLM
                judge scores and human expert scores. Aim for 80%+ agreement.
              </li>
              <li>
                <strong>Iterate on disagreements:</strong> When the judge and human disagree, update
                the rubric to clarify the edge case.
              </li>
              <li>
                <strong>Use chain-of-thought reasoning:</strong> Ask the judge to explain its
                reasoning before scoring. This improves accuracy and debuggability.
              </li>
              <li>
                <strong>Separate dimensions:</strong> Break complex evaluations into multiple
                focused rubrics rather than one catch-all criterion.
              </li>
            </ol>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              <li>
                <strong>Rubrics that are too generic:</strong> "Is the response good?" doesn't
              ...
              <li>
                ...
                to inconsistent scoring
              </li>
              <li>
                <strong>Not accounting for context:</strong> The same output might be good in one
                scenario and bad in another
              </li>
              <li>
                <strong>Judging the judge:</strong> Using GPT-4 to judge GPT-4 can introduce model
                biases
              </li>
            </ul>
            ...
            <div className="rounded-lg border border-border bg-card p-6 mt-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Our platform includes a rubric builder with templates for common use cases. Start
                evaluating your AI outputs in minutes.
              </p>
              <Button asChild>
