        ...
        <article>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none text-sm sm:text-base">
            ...
            <p className="text-muted-foreground mb-4">
              TechFlow (name changed), a B2B SaaS platform with 50,000 users, launched an AI support
              chatbot to handle common customer questions. The goal was ambitious: deflect 60% of
              support tickets and reduce response time from hours to seconds.
            </p>
            <p className="text-muted-foreground mb-4">
              Initial results were promising. The chatbot handled thousands of conversations per
              week, and customers praised the instant responses. But the support team noticed a
              troubling pattern: escalations to human agents were increasing, not decreasing.
            </p>
            <p className="text-muted-foreground mb-4">
              The problem? The chatbot was confident but often wrong. It would confidently state
              incorrect information about features, billing, or account settings. Users would try to
              follow its advice, fail, get frustrated, and escalate to human support—now with two
            ...
            <p className="text-muted-foreground mb-4">
              TechFlow's engineering team partnered with their support leads to build a
              comprehensive evaluation system. Here's how they did it:
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              First, they needed to quantify what "good" looked like. The support team manually
              reviewed 500 chatbot conversations and categorized errors:
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              <li>
                <strong>Hallucinations (42%):</strong> Made up features that don't exist
              </li>
              <li>
                <strong>Outdated info (28%):</strong> Correct 6 months ago, wrong now
              </li>
              <li>
                <strong>Misunderstanding intent (18%):</strong> Answered the wrong question
              </li>
              <li>
                <strong>Wrong tone (12%):</strong> Too casual or dismissive for enterprise customers
              </li>
            </ul>
            <p className="text-muted-foreground mb-4">
              They also created a gold standard test set of 150 real customer questions with
              expert-reviewed "ideal" responses, covering common scenarios and known failure modes.
            </p>
...
4. Safety (Pass/Fail)
   ...
   - Must not make guarantees about timelines or pricing`}
            ...
            <p className="text-muted-foreground mb-4">
              They ran their current chatbot through this evaluation: 67/150 test cases failed (55%
              pass rate). Now they had a baseline to improve against.
            </p>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              ...
              <li>
                Added explicit instruction: "Only answer based on provided context. If unsure, say
                so."
              </li>
              <li>
            ...
            <p className="text-muted-foreground mb-4">
              With strong eval performance, they rolled out the improved chatbot to 10% of users.
              They tracked:
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
            ...
            <p className="text-muted-foreground mb-4">
              The A/B test confirmed eval gains translated to production improvements. They expanded
              to 100% of traffic.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              Before building evals, the team was flying blind. They knew the chatbot had issues but
              couldn't quantify them or track progress. Once they had metrics, improvement was
              straightforward.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              The support team's domain knowledge was critical for building effective rubrics.
              Engineers alone wouldn't have identified the right evaluation criteria.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              Rather than one big rewrite, they made targeted improvements and measured impact after
              each change. This made it easy to identify what worked and what didn't.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              The correlation between eval pass rate and production metrics was strong (r=0.89).
              This gave the team confidence to ship changes without long A/B tests for every
              iteration.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              TechFlow now runs evals on every code change and continuously expands their test set
              based on production failures. Evaluation became part of their development workflow,
              not a separate phase.
            </p>

            <h2 className="text-2xl font-bold mb-4 mt-8">What's Next</h2>
            <p className="text-muted-foreground mb-4">With a solid foundation, TechFlow is now:</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
            ...
            <div className="rounded-lg border border-border bg-card p-6 mt-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                See how our platform can help you evaluate and improve your AI chatbot. Includes
                templates for customer support use cases.
              </p>
              <Button asChild>
