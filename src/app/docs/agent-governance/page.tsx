...
import { ArrowRight, Shield, Users, DollarSign, Clock, Settings, CheckCircle } from "lucide-react";
...
export default function AgentGovernancePage() {
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold mb-2">Agent Governance Framework</h1>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
              <p className="text-sm text-purple-600 dark:text-purple-400">
                EvalAI's orchestration layer provides enterprise-grade governance for multi-agent AI systems. 
                This framework enables organizations to deploy, monitor, audit, and optimize AI agents with 
                full compliance and cost visibility.
              </p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="bg-muted rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody>
                      <tr>
                        <td className="py-2"><strong>Reasoning Chain</strong></td>
                        <td className="py-2">Full explanation of why this decision was made over alternatives</td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>Confidence Scores</strong></td>
                        <td className="py-2">0-100 scale indicating decision certainty</td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>Cost Attribution</strong></td>
                        <td className="py-2">Per-agent, per-model cost breakdown</td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>Execution Timestamps</strong></td>
                        <td className="py-2">Precise timing for regulatory reporting</td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>Alternative Analysis</strong></td>
                        <td className="py-2">What other options were considered and why they were rejected</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
  ...
  timestamp: "2024-01-15T10:30:00Z"
              ...
              <div>
                <h3 className="font-semibold mb-3">Supported Compliance Standards</h3>
                <div className="bg-muted rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                    ...
                    <tbody>
                      <tr>
                        <td className="py-2"><strong>SOC2</strong></td>
                        <td className="py-2">Service Organization Control</td>
                        <td className="py-2"><code>auditLevel: 'SOC2'</code></td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>GDPR</strong></td>
                        <td className="py-2">EU Data Protection</td>
                        <td className="py-2"><code>auditLevel: 'GDPR'</code></td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>HIPAA</strong></td>
                        <td className="py-2">Healthcare Data</td>
                        <td className="py-2"><code>auditLevel: 'HIPAA'</code></td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>FINRA 4511</strong></td>
                        <td className="py-2">Financial Services</td>
                        <td className="py-2"><code>auditLevel: 'FINRA_4511'</code></td>
                      </tr>
                      <tr>
                        <td className="py-2"><strong>PCI DSS</strong></td>
                        <td className="py-2">Payment Card Industry</td>
                        <td className="py-2"><code>auditLevel: 'PCI_DSS'</code></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Low Confidence:</strong> Decision confidence below threshold (default: 70%)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-2 w-2 rounded-full bg-orange-500 mt-2"></div>
                    <div>
                      <strong>High Value:</strong> Transaction amount exceeds threshold (default: $500)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-2 w-2 rounded-full bg-yellow-500 mt-2"></div>
                    <div>
                      <strong>Sensitive Data:</strong> Context contains sensitive information
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-2 w-2 rounded-full bg-purple-500 mt-2"></div>
                    <div>
                      <strong>PII Detected:</strong> Personally identifiable information in context
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-2 w-2 rounded-full bg-blue-500 mt-2"></div>
                    <div>
                      <strong>Restricted Classification:</strong> Data marked as "restricted"
                    </div>
                  </div>
                </div>
              </div>
...
CompliancePresets.PCI_DSS`}</pre>
          ...
          <Card className="p-6 mt-8">
            <div className="text-center">
              <h2 className="text-xl font-semibold mb-4">Implement Governance</h2>
