...
import { ArrowRight, Code, Package, GitBranch, Zap, BookOpen } from "lucide-react";
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold mb-2">Integration Reference</h1>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="text-sm text-blue-600 dark:text-blue-400">
                <strong>Generated from source code</strong> — every type, endpoint, and method signature below is real.
              </p>
            </div>
          </div>
              ...
              <table className="w-full">
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="py-2"><code>@pauly4010/evalai-sdk</code></td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 font-semibold">Version</td>
                    <td className="py-2"><code>1.5.0</code></td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 font-semibold">Source</td>
                    <td className="py-2"><code>src/packages/sdk/</code></td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 font-semibold">Exports</td>
                    <td className="py-2"><code>.</code> (main), <code>./assertions</code>, <code>./testing</code>, <code>./integrations/openai</code>, <code>./integrations/anthropic</code></td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 font-semibold">Peer deps</td>
                    <td className="py-2"><code>openai ^4.0.0</code> (optional), <code>@anthropic-ai/sdk ^0.20.0</code> (optional)</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 font-semibold">Node</td>
                    <td className="py-2"><code>&gt;=16.0.0</code></td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold">CLI</td>
                    <td className="py-2"><code>npx evalai</code> → <code>./dist/cli/index.js</code></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* AIEvalClient */}
          <Card className="p-6 mb-8">
            <h2 className="text-xl font-semibold mb-4">AIEvalClient — Constructor & Auth</h2>
            
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">Option A: Zero-config (reads env vars)</h3>
...
const client = AIEvalClient.init();`}</pre>
              ...
              <div>
                <h3 className="font-semibold mb-2">Option B: Explicit config</h3>
  ...
  cacheSize: 1000,                  // GET request cache entries
              ...
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3">
                <p className="text-sm text-green-600 dark:text-green-400">
                  <strong>Auth pattern:</strong> Every request sends <code className="bg-green-100 dark:bg-green-800 px-1 rounded">Authorization: Bearer &lt;apiKey&gt;</code> header.
                </p>
              </div>
            </div>
          </Card>
...
client.organizations   → OrganizationsAPI`}</pre>
  ...
  search?: string,
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <div className="bg-muted rounded-lg p-3 font-mono text-sm">
                    <code>client.traces.get(id: number) → Promise&lt;Trace&gt;</code>
                  </div>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Delete trace</h3>
                  <div className="bg-muted rounded-lg p-3 font-mono text-sm">
                    <code>client.traces.delete(id: number) → Promise&lt;{"{ message: string }"}&gt;</code>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Card className="p-6 mb-8">
            <h2 className="text-xl font-semibold mb-4">EvaluationAPI Methods</h2>
