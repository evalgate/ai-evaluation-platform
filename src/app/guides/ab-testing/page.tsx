			...
			<div className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
				...
				<div className="mb-6 sm:mb-8">
					...
					<p className="text-base sm:text-lg text-muted-foreground">
						Learn how to run controlled experiments to improve your LLM
				...
				<div className="prose prose-sm sm:prose-base max-w-none">
					<section className="mb-8 sm:mb-12">
						...
						<p className="mb-4 text-sm sm:text-base text-muted-foreground">
							A/B testing allows you to validate changes to your LLM application
							with real users before full deployment. This is critical because:
						</p>
					...
					<section className="mb-8 sm:mb-12">
						...
						<div className="mb-6 rounded-lg border border-border bg-card p-4 sm:p-6">
							...
							<p className="mb-3 sm:mb-4 text-sm sm:text-base text-muted-foreground">
								Start by creating two or more variants of your LLM
								configuration:
							</p>
    ...
    prompt: "Provide a detailed..."
						...
						<div className="mb-6 rounded-lg border border-border bg-card p-4 sm:p-6">
							...
							<ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
								<li>
									• <strong>User engagement:</strong> Click-through rates, time
									spent
								</li>
								<li>
									• <strong>Quality metrics:</strong> Thumbs up/down, user
									ratings
								</li>
								<li>
									• <strong>Task completion:</strong> Conversion rates, success
									rates
								</li>
								<li>
					...
					<section className="mb-8 sm:mb-12">
						...
						<p className="mb-4 text-sm sm:text-base text-muted-foreground">
							Use our platform to randomly assign users to variants and track
							results:
						</p>
						<div className="rounded-md bg-muted p-3 sm:p-4">
							<code className="text-xs sm:text-sm">
					...
					<section className="mb-8 sm:mb-12">
						...
						<div className="rounded-lg border border-yellow-500/20 bg-yellow-500/5 p-4 sm:p-6">
							...
							<p className="text-sm sm:text-base text-muted-foreground">
								Wait for statistical significance before making decisions. Our
								platform calculates p-values and confidence intervals
								automatically. Generally, you need:
							</p>
					...
					<section className="mb-8 sm:mb-12">
						...
						<div className="grid gap-4 sm:gap-6 sm:grid-cols-2">
							<div className="rounded-lg border border-border bg-card p-4 sm:p-5">
								...
								<p className="text-sm sm:text-base text-muted-foreground">
									Change only one variable at a time to understand what drives
									improvements
								</p>
							</div>
							<div className="rounded-lg border border-border bg-card p-4 sm:p-5">
								...
								<p className="text-sm sm:text-base text-muted-foreground">
									Collect data for at least one full business cycle to account
									for variations
								</p>
							</div>
							<div className="rounded-lg border border-border bg-card p-4 sm:p-5">
								...
								<p className="text-sm sm:text-base text-muted-foreground">
									Track token usage and API costs across variants to ensure
							...
							<div className="rounded-lg border border-border bg-card p-4 sm:p-5">
								...
								<p className="text-sm sm:text-base text-muted-foreground">
									Keep detailed records of hypotheses, configurations, and
