			...
			<main className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12 flex-1">
				...
				<div className="mb-6 sm:mb-8">
					...
					<p className="text-base sm:text-lg text-muted-foreground">
						Ensure consistent tone, style, and accuracy when generating
						marketing copy or articles.
					</p>
				...
				<div className="prose prose-sm sm:prose-base max-w-none">
					...
					<p>
						LLMs can generate content at scale, but quality varies dramatically.
						Without proper evaluation, you risk publishing off-brand,
						inaccurate, or low-quality content that damages your reputation.
					</p>
					...
					<div className="bg-card border border-border p-6 rounded-lg my-6">
						<p className="mb-2">
							<strong>Brand: Professional B2B SaaS</strong>
						</p>
						<p className="text-sm mb-2">
							✅ "Our platform helps enterprises streamline workflows"
						</p>
						<p className="text-sm mb-0">
							❌ "Check out this awesome tool that'll blow your mind!"
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>Grammar & spelling:</strong> Zero tolerance for errors
						</li>
						<li>
							<strong>Clarity:</strong> Easy to understand for target audience
						</li>
						<li>
							<strong>Structure:</strong> Logical flow with clear transitions
						</li>
						<li>
							<strong>Engagement:</strong> Compelling and keeps readers
							interested
						</li>
					</ul>
					...
					<div className="bg-muted p-4 rounded-lg text-sm my-4">
						...
						<ul className="mb-0 space-y-1">
							<li>
								<strong>Tone:</strong> Professional yet approachable
							</li>
							<li>
								<strong>Voice:</strong> Active voice, second person ("you")
							</li>
							<li>
								<strong>Vocabulary:</strong> Avoid jargon unless defining it
							</li>
							<li>
								<strong>Sentence length:</strong> Average 15-20 words
							</li>
							<li>
								<strong>Forbidden phrases:</strong> "Revolutionize,"
								"game-changer," "leverage"
							</li>
						</ul>
					</div>
					...
					<div className="bg-muted p-4 rounded-lg text-sm my-4">
						...
						<p className="mb-0">
							"You are an expert content editor for [Brand]. Evaluate this
							generated content on: (1) Brand voice alignment (1-5), (2) Factual
							accuracy (1-5), (3) Writing quality (1-5), (4) SEO optimization
							(1-5). Our brand is [tone] and targets [audience]. Flag unknown
...
assert(similarity < 0.15); // Less than 15% similar to existing content`}
					...
					<ol>
						<li>
							<strong>Generate:</strong> LLM creates first draft
						</li>
						<li>
							<strong>Automated checks:</strong> Grammar, readability,
							plagiarism
						</li>
						<li>
							<strong>LLM judge:</strong> Evaluates brand voice and quality
						</li>
						<li>
							<strong>Fact verification:</strong> LLM judge flags claims to
							verify
						</li>
						<li>
							<strong>Human review:</strong> Editor reviews flagged items
						</li>
						<li>
							<strong>Revision:</strong> Regenerate or manually edit failures
						</li>
						<li>
							<strong>Final approval:</strong> Re-evaluate revised content
						</li>
					</ol>
					...
					<div className="bg-card border border-border p-6 rounded-lg my-6">
						...
						<p className="text-sm mb-1">
							<strong>Draft 1:</strong> Score 3.2/5 (weak brand voice, needs
							more examples)
						</p>
						<p className="text-sm mb-1">
							<strong>Revision prompt:</strong> "Rewrite in a more professional
							tone. Add 2 real-world examples."
						</p>
						<p className="text-sm mb-0">
							<strong>Draft 2:</strong> Score 4.5/5 (approved for publication)
						</p>
					</div>
					...
					<div className="bg-muted p-4 rounded-lg text-sm my-4">
						<p className="mb-2">
							<strong>Bad:</strong> "AI is transforming businesses across
							industries."
						</p>
						<p className="mb-0">
							<strong>Good:</strong> "Retail brands using AI for inventory
							forecasting reduced stockouts by 34% in Q4 2024."
						</p>
					</div>

					<h3>2. Off-Brand Tone</h3>
					<p>
						LLMs default to overly formal or generic corporate speak. Fine-tune
						prompts with brand voice examples.
					</p>

					<h3>3. Hallucinated Statistics</h3>
					<p>
						Always fact-check numbers and claims. Use RAG with verified data
						sources.
					</p>

					<h3>4. Keyword Stuffing</h3>
					<p>
						Avoid unnatural repetition of keywords. Aim for 1-2% keyword
						density.
					</p>
...
const content = await llm.generate({
  ...
  instruction: "Only use information from the provided context"
					...
					<ul>
						<li>
							<strong>Engagement:</strong> Time on page, scroll depth
						</li>
						<li>
							<strong>SEO:</strong> Keyword rankings, organic traffic
						</li>
						<li>
							<strong>Conversion:</strong> Click-through rate, sign-ups
						</li>
						<li>
							<strong>User feedback:</strong> Comments, shares, ratings
						</li>
					</ul>
					...
					<div className="bg-card border border-border p-6 rounded-lg my-6">
						...
						<p>
							<strong>Volume:</strong> 20 blog posts per month
						</p>
						<p>
					...
					<div className="grid gap-3 sm:gap-4">
						...
						>
							...
							<div className="text-xs sm:text-sm text-muted-foreground">
								Create brand-specific evaluators
							</div>
						</Link>
						<Link
						...
						>
							...
							<div className="text-xs sm:text-sm text-muted-foreground">
								Test content variants with users
							</div>
						</Link>
					</div>
				</div>
