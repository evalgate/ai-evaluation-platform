    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12 flex-1">
        ...
        <div className="prose prose-sm sm:prose-base max-w-none">
          ...
          <p>
            LLMs can generate content at scale, but quality varies dramatically. Without proper
            evaluation, you risk publishing off-brand, inaccurate, or low-quality content that
          ...
          <ul>
            ...
            <li>
              <strong>Engagement:</strong> Compelling and keeps readers interested
            </li>
          </ul>
          ...
          <div className="bg-muted p-4 rounded-lg text-sm my-4">
            ...
            <ul className="mb-0 space-y-1">
              ...
              <li>
                <strong>Forbidden phrases:</strong> "Revolutionize," "game-changer," "leverage"
              </li>
            </ul>
          </div>
...
assert(similarity < 0.15); // Less than 15% similar to existing content`}
          ...
          <ol>
            ...
            <li>
              <strong>Automated checks:</strong> Grammar, readability, plagiarism
            </li>
            <li>
              <strong>LLM judge:</strong> Evaluates brand voice and quality
            </li>
            <li>
              <strong>Fact verification:</strong> LLM judge flags claims to verify
            </li>
            <li>
          ...
          <div className="bg-card border border-border p-6 rounded-lg my-6">
            ...
            <p className="text-sm mb-1">
              <strong>Draft 1:</strong> Score 3.2/5 (weak brand voice, needs more examples)
            </p>
            <p className="text-sm mb-1">
              <strong>Revision prompt:</strong> "Rewrite in a more professional tone. Add 2
              real-world examples."
            </p>
          ...
          <div className="bg-muted p-4 rounded-lg text-sm my-4">
            <p className="mb-2">
              <strong>Bad:</strong> "AI is transforming businesses across industries."
            </p>
            <p className="mb-0">
              <strong>Good:</strong> "Retail brands using AI for inventory forecasting reduced
              stockouts by 34% in Q4 2024."
            </p>
          </div>

          <h3>2. Off-Brand Tone</h3>
          <p>
            LLMs default to overly formal or generic corporate speak. Fine-tune prompts with brand
            voice examples.
          </p>
