				...
				<div className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
					...
					<div className="mb-8 sm:mb-12">
						...
						<p className="text-base sm:text-lg text-muted-foreground">
							Learn how to evaluate Retrieval-Augmented Generation systems for
					...
					<div className="prose prose-gray dark:prose-invert max-w-none">
						...
						<p>
							...
							retrieval with LLM generation. Instead of relying solely on the
							model's training data, RAG systems retrieve relevant documents
							from a knowledge base and use them as context for generating
							responses.
						</p>
						...
						<ul>
							...
							<li>
								<strong>Generation:</strong> Did the LLM use the context
								correctly?
							</li>
							<li>
								<strong>Grounding:</strong> Is the answer supported by retrieved
								docs?
							</li>
						</ul>
						...
						<ul>
							<li>
								<strong>Precision@K:</strong> Of the top K retrieved docs, how
								munknown are relevant?
							</li>
							<li>
								<strong>Recall@K:</strong> Of all relevant docs, how munknown
								are in top K?
							</li>
							<li>
								<strong>MRR (Mean Reciprocal Rank):</strong> Position of first
								relevant document
							</li>
							<li>
						...
						<ul>
							<li>
								<strong>Context Relevance Score:</strong> LLM judges if context
								helps answer the query (1-5)
							</li>
							<li>
								<strong>Context Precision:</strong> % of retrieved chunks that
								are relevant
							</li>
						</ul>
						...
						<div className="bg-muted p-4 rounded-lg text-sm my-4">
							<p className="mb-0">
								"Given this query: [QUERY] and retrieved context: [CONTEXT],
								rate how relevant this context is for answering the query on a
								scale of 1-5. A score of 5 means the context directly answers
								the query. A score of 1 means the context is completely
								irrelevant."
							</p>
						</div>
						...
						<p>
							Is the generated answer grounded in the retrieved context, or is
							it hallucinating?
						</p>
						...
						<ul>
							<li>
								<strong>Faithfulness Score:</strong> % of claims in answer
								supported by context
							</li>
							<li>
								<strong>Citation Coverage:</strong> Are all facts attributed to
								sources?
							</li>
						</ul>
...
assert(faithfulness >= 0.95); // 95%+ claims must be supported`}
						...
						<div className="bg-card border border-border p-6 rounded-lg my-6">
							...
							<p className="text-sm mb-2">
								<strong>Bad (not relevant):</strong> "We offer free shipping on
								orders over $50."
							</p>
							<p className="text-sm mb-0">
								<strong>Good:</strong> "Standard shipping takes 5-7 business
								days."
							</p>
						</div>
						...
						<ul>
							<li>
								<strong>Exact match:</strong> For factual queries (dates,
								numbers)
							</li>
							<li>
								<strong>Semantic similarity:</strong> Compare to reference
								answer
							</li>
							<li>
						...
						<div className="bg-muted p-4 rounded-lg text-sm my-4">
							...
							<p className="text-sm mb-1">
								<strong>Query:</strong> "What is the maximum file size for
								uploads?"
							</p>
							<p className="text-sm mb-1">
								<strong>Expected Answer:</strong> "The maximum file size is
								100MB per file"
							</p>
							<p className="text-sm mb-1">
								<strong>Relevant Docs:</strong> ["docs/upload-limits.md",
								"docs/faq.md"]
							</p>
							<p className="text-sm mb-0">
...
assert(faithfulness >= 0.95);`}
						...
						<div className="bg-card border border-border p-4 rounded-lg my-6">
							<p className="text-sm mb-2">
								<strong>Problem:</strong> Query uses different terminology than
								documents
							</p>
							<p className="text-sm mb-2">
							...
							<p className="text-sm mb-0">
								<strong>Solution:</strong> Query expansion, synonyms, hybrid
						...
						<p>
							<strong>Solution:</strong> Rerank and truncate to most relevant
							chunks.
						</p>
						...
						<div className="bg-muted p-4 rounded-lg text-sm my-4">
							<p className="mb-2">
								<strong>Context:</strong> "Our support team responds within 24
								hours on weekdays."
							</p>
							<p className="mb-2">
								<strong>Bad Answer:</strong> "Support responds within 24 hours,
								including weekends."
							</p>
							<p className="mb-0">
						...
						<p>
							<strong>Solution:</strong> Add instruction: "Only use information
							from the provided context. If unsure, say so."
						</p>
						...
						<p>
							<strong>Solution:</strong> Improve generation prompt to cover all
							relevant points from context.
						</p>
...
const combined = reciprocalRankFusion(semanticResults, keywordResults);`}
						...
						<div className="bg-muted p-4 rounded-lg text-sm my-4">
							<p className="mb-1">
								<strong>Original:</strong> "How do I do that thing with the
								files?"
							</p>
							<p className="mb-0">
								<strong>Rewritten:</strong> "How to upload files? What is the
								file size limit?"
							</p>
						</div>
						...
						<ul>
							<li>
								<strong>Answer rate:</strong> % of queries answered vs. "I don't
								know"
							</li>
							<li>
							...
							<li>
								<strong>Context usage:</strong> Are retrieved docs actually
								being used?
							</li>
						</ul>
