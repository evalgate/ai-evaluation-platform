			...
			<main className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12 flex-1">
				...
				<div className="mb-6 sm:mb-8">
					...
					<p className="text-base sm:text-lg text-muted-foreground">
						Learn the differences between unit tests, human evaluation, LLM
						judges, and A/B testing.
					</p>
				...
				<div className="prose prose-sm sm:prose-base max-w-none">
					...
					<h2>1. Unit Tests</h2>
					<p>
						<strong>Best for:</strong> Regression testing, deterministic
						behavior, continuous integration
					</p>
					<div className="bg-card border border-border p-6 rounded-lg my-6">
						<h3 className="mt-0">How It Works</h3>
						<p>
							Unit tests define explicit input/output pairs and assertion rules.
							They pass or fail based on deterministic criteria like exact
							string matching, regex patterns, or programmatic checks.
						</p>
					</div>
					<p>
					...
					<p>
						<strong>Limitations:</strong> Can be brittle for creative or
						open-ended tasks.
					</p>

					<h2>2. Human Evaluation</h2>
					<p>
						<strong>Best for:</strong> Subjective quality, nuanced tasks, ground
						truth establishment
					</p>
					<div className="bg-card border border-border p-6 rounded-lg my-6">
						<h3 className="mt-0">How It Works</h3>
						<p>
							Human evaluators review AI outputs and provide ratings or
							feedback. The platform presents test cases to annotators, collects
							their judgments, and aggregates results into quality scores.
						</p>
					</div>
					<p>
						<strong>When to use:</strong>
					...
					<p>
						<strong>Limitations:</strong> Slow, expensive, and doesn't scale to
						large test suites.
					</p>

					<h2>3. LLM Judge</h2>
					<p>
						<strong>Best for:</strong> Scalable quality assessment, complex
						reasoning tasks, mimicking human judgment
					</p>
					<div className="bg-card border border-border p-6 rounded-lg my-6">
						<h3 className="mt-0">How It Works</h3>
						<p>
							A separate LLM (the "judge") evaluates outputs from your target
							LLM based on custom rubrics. The judge scores outputs on
							dimensions like accuracy, relevance, helpfulness, or safety.
						</p>
					</div>
					<p>
						<strong>When to use:</strong>
					...
					<p>
						<strong>Limitations:</strong> Judges can have biases and may not
						catch all edge cases.
					</p>

					<h2>4. A/B Testing</h2>
					<p>
						<strong>Best for:</strong> Production experimentation, comparing
						model versions, data-driven decisions
					</p>
					<div className="bg-card border border-border p-6 rounded-lg my-6">
						<h3 className="mt-0">How It Works</h3>
						<p>
							Traffic is split between two variants (e.g., old prompt vs. new
							prompt, GPT-3.5 vs. GPT-4). Statistical analysis determines which
							performs better based on real user interactions.
						</p>
					</div>
					<p>
						<strong>When to use:</strong>
					...
					<p>
						<strong>Limitations:</strong> Requires significant traffic and time
					...
					<div className="bg-muted p-6 rounded-lg my-6">
						...
						<ol className="mb-0">
							<li>
								<strong>Development:</strong> Run unit tests on every commit
							</li>
							<li>
								<strong>Pre-release:</strong> Use LLM judge on comprehensive
								test suite
							</li>
							<li>
								<strong>Validation:</strong> Human evaluation on sample of
								critical cases
							</li>
							<li>
								<strong>Production:</strong> A/B test with real users to confirm
								improvements
							</li>
						</ol>
					</div>
					...
					<ul>
						<li>
							...
							>
								Create your first unit test evaluation
							</Link>
						</li>
						<li>
							<Link
								...
								className="text-blue-500 hover:underline"
							>
								Learn to build custom LLM judge rubrics
							</Link>
						</li>
						<li>
							<Link
								...
								className="text-blue-500 hover:underline"
							>
								Run your first A/B test in production
							</Link>
						</li>
					</ul>
				</div>
