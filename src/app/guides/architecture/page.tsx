    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
          ...
          {/* Hero */}
          <div className="mb-12">
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">Architecture Overview</h1>
...
└── drizzle/              # Database migrations`}</pre>
          ...
          <div className="grid gap-6 mb-8">
            <Card className="p-6">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>• 55+ API endpoints for evaluations, traces, and LLM judge</li>
          ...
          <Card className="p-6 mb-8">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <h3 className="font-semibold mb-2 text-blue-600">Evaluations</h3>
                <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-orange-600">Core Services</h3>
                <ul className="text-sm text-muted-foreground space-y-1">
          ...
          <Card className="p-6">
            <div className="text-center">
              <h2 className="text-xl font-semibold mb-4">Explore the Architecture</h2>
