...
const validators: Validator[] = [
	{
		name: "Factuality",
		description:
			"Checks factual correctness using LLM-judge consensus and knowledge base verification.",
		icon: CheckCircle2,
		category: "Quality",
		color: "text-blue-500",
	},
	{
		name: "Toxicity",
		description:
			"Detects unsafe, biased, or harmful responses using multi-model detection.",
		icon: Shield,
		category: "Safety",
		color: "text-red-500",
	},
	{
		name: "RegexMatch",
		description:
			"Ensures model output conforms to a specific pattern or format.",
		icon: Regex,
		category: "Structure",
	...
	},
	{
		name: "JSONSchema",
		description:
			"Validates JSON outputs against a defined schema with type checking.",
		icon: FileJson,
		category: "Structure",
	...
	},
	{
		name: "Cost",
		description:
			"Tracks token usage and calculates estimated USD cost per operation.",
		icon: DollarSign,
		category: "Performance",
	...
	},
	{
		name: "Determinism",
		description:
			"Compares multiple runs for consistency and stability of outputs.",
		icon: Target,
		category: "Quality",
	...
	},
	{
		name: "Hallucination",
		description:
			"Detects when AI generates information not present in source context.",
		icon: AlertTriangle,
		category: "Quality",
	...
	},
	{
		name: "Relevance",
		description:
			"Measures how well the output addresses the input query or prompt.",
		icon: Sparkles,
		category: "Quality",
		color: "text-pink-500",
	},
	...
	},
	{
		name: "Groundedness",
		description:
			"Verifies that responses are grounded in provided context or documentation.",
		icon: Database,
		category: "Quality",
	...
	},
	{
		name: "Coherence",
		description:
			"Evaluates logical flow and consistency within the generated response.",
		icon: Zap,
		category: "Quality",
		...
		<div className="container mx-auto px-4 py-12 max-w-7xl">
			...
			<div className="text-center mb-12">
				...
				<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
					Pre-built validators for every aspect of LLM evaluation. From
					factuality to performance, ensure your AI outputs meet quality
					standards.
				</p>
			</div>
			...
			{categories.map((category) => (
				<div key={category} className="mb-12">
					<div className="flex items-center gap-3 mb-6">
						...
						>
							{validators.filter((v) => v.category === category).length}{" "}
							validators
						</Badge>
					</div>
			...
			<Card className="p-8 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-blue-500/20">
				<div className="text-center">
					...
					<p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
						Create your own validators using our SDK. Define custom logic,
						thresholds, and scoring functions tailored to your specific use
						case.
					</p>
