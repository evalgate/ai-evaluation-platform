			...
			setBenchmarks([
				{
					...
					description:
						"Evaluate agent responses for customer support scenarios",
					taskType: "qa",
					isPublic: true,
								...
								>
									<CardContent className="p-6">
										<div className="flex items-start justify-between mb-2">
											...
											<Badge
												variant={benchmark.isPublic ? "default" : "secondary"}
											>
										...
										<div className="flex items-center gap-4 text-xs text-muted-foreground mb-4">
											<Badge variant="outline">
												{TASK_TYPE_LABELS[benchmark.taskType] ||
													benchmark.taskType}
											</Badge>
											{benchmark._stats && (
										...
										{benchmark._stats?.topPerformer && (
											<div className="p-3 bg-muted rounded-lg">
												...
												<p className="text-sm">
													{benchmark._stats.topPerformer.name}
												</p>
								...
								{[
									{
										name: "ReAct",
										description:
											"Best for tool-heavy workflows and interactive tasks",
									...
									},
									{
										name: "Chain-of-Thought",
										description:
											"Best for complex reasoning and explanation tasks",
									...
									},
									{
										name: "Tree-of-Thought",
										description:
											"Best for exploration and creative problem solving",
