...
export default function APIKeysPage() {
	...
	}, [session, organizationId, fetchAPIKeys]);
						...
						<div className="rounded-lg border border-yellow-500/50 bg-yellow-500/10 p-4">
							<div className="flex gap-2">
								...
								<div className="space-y-1">
									...
									<p className="text-xs text-muted-foreground">
										Store this key securely. unknownone with this key can access
										your organization's data within the granted scopes. Never
			...
			<AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							This will immediately revoke the API key. unknown applications
							using this key will no longer be able to access the API. This
