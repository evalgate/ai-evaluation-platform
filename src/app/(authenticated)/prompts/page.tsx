	...
	const prompts = [
		{
			...
			description:
				"Evaluate customer service chatbot responses for accuracy and helpfulness",
...
Provide scores and brief explanations for each criterion.`,
		...
		},
		{
			...
			description:
				"Detect when AI generates information not present in source documents",
			category: "RAG",
...
List specific examples of unknown hallucinations found.`,
		...
		},
		{
			...
			description:
				"Evaluate generated code for correctness, efficiency, and best practices",
...
Provide scores and specific feedback for improvements.`,
		...
		},
		{
			...
			description:
				"Assess generated content for clarity, engagement, and brand alignment",
				...
				<CardContent className="py-8">
					<div className="text-center space-y-4">
						...
						<p className="text-muted-foreground max-w-2xl mx-auto">
							Create your own evaluation prompts tailored to your specific use
							case
						</p>
						<Button size="lg">
							<Plus className="mr-2 h-4 w-4" />
