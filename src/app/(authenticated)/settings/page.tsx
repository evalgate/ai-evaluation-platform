...
export default function SettingsPage() {
	...
	return (
		<div className="flex-1 space-y-4 sm:space-y-6">
									...
									{webhooks.map((webhook) => (
										...
										>
											<div className="flex-1 space-y-1">
												...
												<p className="text-xs text-muted-foreground mt-1">
													Last delivered: {formatDate(webhook.lastDeliveredAt)}{" "}
			...
			<Dialog
				open={createWebhookDialogOpen}
				onOpenChange={setCreateWebhookDialogOpen}
			>
				<DialogContent className="max-w-md">
					<DialogHeader>
					...
					{createdWebhookSecret ? (
						<div className="space-y-4">
							...
							<div className="space-y-2">
								...
								<p className="text-xs text-amber-600">
									⚠️ Save this secret for webhook signature verification. You
						...
						<div className="space-y-4">
							...
							<DialogFooter>
								<Button
									variant="outline"
									onClick={() => setCreateWebhookDialogOpen(false)}
								>
									Cancel
								</Button>
