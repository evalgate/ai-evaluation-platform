...
export default function CostsPage() {
  ...
  useEffect(() => {
    if (!isPending && !session?.user) {
      // Demo data
      setSummary({
        last30Days: { totalCost: 245.67, totalTokens: 12500000, requestCount: 8420 },
        last7Days: { totalCost: 58.23, totalTokens: 3100000, requestCount: 2105 },
        topModels: [
          { provider: 'openai', model: 'gpt-4o', totalCost: 125.50, requestCount: 3200 },
          { provider: 'anthropic', model: 'claude-3.5-sonnet', totalCost: 78.30, requestCount: 2800 },
          { provider: 'openai', model: 'gpt-4o-mini', totalCost: 25.12, requestCount: 1500 },
          { provider: 'openai', model: 'text-embedding-3-small', totalCost: 12.45, requestCount: 820 },
          { provider: 'google', model: 'gemini-1.5-flash', totalCost: 4.30, requestCount: 100 },
        ]
      })
      setTrends([
        { date: '2024-01-01', totalCost: 8.50, tokenCount: 450000, requestCount: 280 },
        { date: '2024-01-02', totalCost: 9.20, tokenCount: 480000, requestCount: 295 },
        { date: '2024-01-03', totalCost: 7.80, tokenCount: 420000, requestCount: 260 },
        { date: '2024-01-04', totalCost: 10.50, tokenCount: 520000, requestCount: 320 },
        { date: '2024-01-05', totalCost: 11.20, tokenCount: 580000, requestCount: 350 },
        { date: '2024-01-06', totalCost: 6.30, tokenCount: 350000, requestCount: 210 },
        { date: '2024-01-07', totalCost: 4.90, tokenCount: 280000, requestCount: 180 },
      ])
      setIsLoading(false)
      return
    }
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {summary.last30Days.requestCount.toLocaleString()} requests
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="flex items-center gap-2">
                ...
                {weekOverWeekChange !== 0 && (
                  <Badge 
                    variant={weekOverWeekChange > 0 ? "destructive" : "secondary"}
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  { provider: 'Google', models: [
                    { name: 'Gemini 1.5 Pro', input: '$3.50', output: '$10.50' },
          ...
          <Card className="border-amber-500/50">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Cost alerting is coming soon. You'll be able to set daily, weekly, and monthly budget alerts.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
