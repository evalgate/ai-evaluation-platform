...
function getDemoScenario(id: string): DemoScenario | null {
	const scenarios: Record<string, DemoScenario> = {
				...
				tests: [
					{
						...
						actual:
							"We're open Monday through Friday, 9am to 5pm Eastern Time.",
						status: "passed",
						score: 95,
					...
					},
					{
						...
						actual:
							'To reset your password, click the "Forgot Password" link on the login page. You\'ll receive an email with instructions.',
						status: "passed",
						score: 98,
					...
					},
					{
						...
						actual:
							"Please contact our support team as soon as possible. If your order hasn't been processed yet, we can make changes.",
						status: "passed",
						score: 88,
			...
			results: {
				...
				tests: [
					...
					},
					{
						...
						context:
							"Contact our support team at support@compunknown.com or call 1-800-555-0123.",
						actual:
							"You can contact support at support@compunknown.com or call 1-800-555-0123.",
						status: "passed",
						hallucinated: false,
						score: 100,
		...
		"code-quality": {
			...
			name: "Code Generation Quality",
			description:
				"Testing if generated code is correct and follows best practices",
			...
			results: {
				...
				tests: [
					...
					},
					{
						...
						score: 60,
						notes:
							"⚠️ Fails on Date objects, functions, and circular references",
					},
				],
			},
			qualityScore: calculateQualityScore({
