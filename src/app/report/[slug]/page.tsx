          ...
          <CardContent className="pt-8 pb-8">
            <div className="flex items-center justify-center gap-12">
              <div className="text-center">
                <div className="text-6xl font-bold text-green-400">{data.passRate ?? 0}%</div>
                <div className="text-sm text-zinc-500 mt-1">Pass Rate</div>
              </div>
              <div className="h-20 w-px bg-zinc-800" />
              <div className="text-center">
                <div className="text-4xl font-bold">{data.averageScore ?? 0}</div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <Card className="bg-green-500/10 border-green-500/20">
            <CardContent className="pt-6 flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-green-400">{data.completedRuns ?? 0}</div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div className="font-mono">{Math.round(data.averageDuration ?? 0)}ms</div>
                </div>
                <div>
                  <span className="text-zinc-500">Total Cost</span>
                  <div className="font-mono">${(data.totalCost ?? 0).toFixed(4)}</div>
                </div>
              </div>
            </CardContent>
          </Card>
