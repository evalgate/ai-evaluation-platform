        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <section className="mb-8 sm:mb-12">
            ...
            <p className="text-muted-foreground mb-4">
              At AI Evaluation Platform ("we," "our," or "us"), we take your privacy seriously. This
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <p className="text-muted-foreground">
              Your data is stored on secure servers located in the United States. We use AWS,
              Vercel, and other trusted cloud providers with SOC 2 Type II certified infrastructure
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>
                ...
                our behalf (e.g., payment processing, hosting)
              </li>
              <li>
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              ...
              <li>
                <strong>Trace Data:</strong> Retained according to your plan limits; automatically
                deleted after 90 days for free tier, 1 year for paid plans
              </li>
              <li>
                <strong>Evaluation Results:</strong> Retained for the duration of your subscription
                plus 90 days
              </li>
              <li>
                <strong>PII in Traces:</strong> We do not automatically scan or redact PII from
                trace data. You are responsible for ensuring compliance with data protection
                regulations when sending trace data containing PII
              </li>
              <li>
                <strong>Backups:</strong> Backup data is retained for 30 days and then permanently
                deleted
              </li>
            </ul>
            <p className="text-muted-foreground">
              Upon account deletion, all associated data is permanently removed from our production
              systems within 30 days, and from backups within 60 days.
            </p>
          </section>
