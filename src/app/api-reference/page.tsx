  ...
  "started_at": "2024-01-15T10:40:00Z"
	...
	},
	{
		...
		endpoints: [
			...
			{
				method: "POST",
				path: "/api/traces/{id}/spans",
				description: "Add span to trace",
			},
		],
	},
	{
		...
		endpoints: [
			{
				method: "GET",
				path: "/api/llm-judge/configs",
				description: "List judge configs",
			},
			{
				method: "POST",
				path: "/api/llm-judge/evaluate",
				description: "Evaluate output",
			},
			{
				method: "GET",
				path: "/api/llm-judge/results",
				description: "Get evaluation results",
			},
			{
				method: "POST",
				path: "/api/llm-judge/alignment",
				description: "Check judge alignment",
			},
		],
	},
	{
		...
		endpoints: [
			{
				method: "GET",
				path: "/api/annotations/tasks",
				description: "List annotation tasks",
			},
			{
				method: "POST",
				path: "/api/annotations/tasks",
			...
			{
				method: "GET",
				path: "/api/annotations/tasks/{id}",
				description: "Get task details",
			},
			{
				method: "POST",
				path: "/api/annotations/tasks/{id}/items",
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-12">
					<div className="mb-8 sm:mb-12">
						...
						<p className="text-base sm:text-lg text-muted-foreground max-w-3xl mb-6">
							Complete REST API documentation for programmatic access to the
							platform
						</p>
									...
									{section.endpoints.map((endpoint, index) => (
										<Card key={index} className="p-4 sm:p-5">
											<div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
												...
												<code className="text-sm sm:text-base font-mono flex-1 break-all">
													{endpoint.path}
												</code>
											</div>
						...
						<Card className="p-5 sm:p-6">
							...
							<div className="space-y-2 text-sm sm:text-base text-muted-foreground">
								...
								<p>
									...
									Too Munknown Requests - Rate limit exceeded
								</p>
								<p>
									•{" "}
									<code className="font-mono bg-muted px-2 py-1 rounded">
