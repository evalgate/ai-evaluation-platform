...
const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_URL || "https://v0-ai-evaluation-platform-nu.vercel.app";
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-12">
          ...
          <section id="authentication" className="mb-8 sm:mb-12">
            <Card className="p-5 sm:p-6">
              ...
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                All API requests require authentication using a bearer token. Get your API key from
                the{" "}
          ...
          <section id="errors" className="mt-8 sm:mt-12">
            <Card className="p-5 sm:p-6">
              ...
              <div className="space-y-2 text-sm sm:text-base text-muted-foreground">
                <p>
                  • <code className="font-mono bg-muted px-2 py-1 rounded">400</code> Bad Request -
                  Invalid parameters
                </p>
                <p>
                  • <code className="font-mono bg-muted px-2 py-1 rounded">401</code> Unauthorized -
                  Invalid API key
                </p>
                <p>
                ...
                <p>
                  • <code className="font-mono bg-muted px-2 py-1 rounded">500</code> Internal
