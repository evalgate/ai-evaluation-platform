...
async function main() {
	const sampleTestCases = [
		...
		},
		{
			evaluationId: 2,
			input:
				"Customer says: Where is my order? I have been waiting for 2 weeks.",
			expectedOutput:
		...
		},
		{
			evaluationId: 5,
			input:
				"Translate to French: Hello, how are you today? I hope you are having a wonderful day.",
			expectedOutput:
		...
		},
		{
			...
			expectedOutput:
				"Le restaurant ouvre à 19 heures et sert une cuisine italienne authentique.",
			metadata: JSON.stringify({
				source_language: "English",
				target_language: "French",
			}),
