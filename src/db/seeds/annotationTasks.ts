	...
	const sampleAnnotationTasks = [
		{
			...
			description:
				"Evaluate the quality and helpfulness of chatbot responses across various customer inquiries",
			type: "rating",
			status: "active",
			organizationId: 1,
			totalItems: 20,
		...
		},
		{
			...
			description:
				"Classify user-generated content for toxic, offensive, or harmful language",
			type: "classification",
			status: "active",
			organizationId: 1,
			totalItems: 50,
		...
		},
		{
			...
			description:
				"Compare and select the better output between two AI model responses",
			type: "comparison",
			status: "completed",
			organizationId: 2,
			totalItems: 15,
