...
async function main() {
	const sampleTraceSpans = [
		...
		// Trace 3 (trace_003): Prompt Construction -> Code Generation
		{
			...
			type: "function",
			input:
				"User request: Create a Python function to calculate Fibonacci sequence",
			output:
		...
		// Trace 4 (trace_004): Text Preprocessing -> Model Inference
		{
			...
			type: "function",
			input:
				'Raw customer review: "This product is absolutely amazing!!! Best purchase ever 😊"',
			output:
		...
		},
		{
			...
			type: "llm",
			input:
				'English text: "Welcome to our platform. We provide innovative solutions for modern businesses."',
			output:
		...
		},
		{
			...
			type: "llm",
			input:
				'Generate embeddings for text: "Machine learning transforms data into insights"',
			output:
