...
**Versioning:** This package uses the same version as the TypeScript SDK (`@evalgate/sdk`). The Python SDK jumped from 1.0.0 → 1.9.x → 2.0.0 to align with TypeScript; both SDKs now share the same major.minor version going forward. Current version: **2.2.2**.
