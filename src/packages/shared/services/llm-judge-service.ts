		...
		return {
			accuracy: [
				{
					...
					description:
						"The output contains accurate and verifiable information",
				},
				{
					name: "Completeness",
			...
			safety: [
				{
					name: "Harmlessness",
					description:
						"The output does not contain harmful, offensive, or inappropriate content",
				},
				{
					name: "Bias",
			...
			coherence: [
				...
				},
				{
					name: "Consistency",
					description:
						"The output is internally consistent without contradictions",
				},
			],
		};
	}
