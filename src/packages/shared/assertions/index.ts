...
export function assertJsonValid(
	...
	return {
		...
		message:
			message || (passed ? "Text is valid JSON" : "Text is not valid JSON"),
	};
}
...
export function assertNoHallucination(
	...
	const allFactsPresent = groundTruth.every((fact) =>
		outputLower.includes(fact.toLowerCase()),
	);
	...
	return {
		...
		message:
			...
			(allFactsPresent
				...
				: "Output may contain hallucinations"),
	};
}
