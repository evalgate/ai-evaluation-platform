...
describe("RUNTIME-101: Runtime Lifecycle Contract", () => {
  ...
  describe("Resource cleanup", () => {
    it("should clear registry after dispose()", () => {
      ...
      // Register some specs
      handle.defineEval("spec1", async (context) => createResult({ pass: true, score: 100 }));
      handle.defineEval("spec2", async (context) => createResult({ pass: true, score: 90 }));
    ...
    it("should release internal caches on dispose", () => {
      ...
      handle.defineEval("cache-test", async (context) => createResult({ pass: true, score: 100 }));
