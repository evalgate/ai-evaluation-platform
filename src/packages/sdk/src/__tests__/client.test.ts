...
describe('AIEvalClient', () => {
  ...
  describe('request method', () => {
    it('should send auth header', async () => {
      ...
      const client = new AIEvalClient({ apiKey: 'my-secret-key', baseUrl: 'http://localhost:3000' });
    ...
    it('should throw on non-ok response', async () => {
      ...
      const client = new AIEvalClient({ apiKey: 'key', baseUrl: 'http://localhost:3000', retry: { maxAttempts: 1 } });
