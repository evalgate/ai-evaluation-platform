...
export function runInit(cwd: string = process.cwd()): boolean {
	...
	if (!project.hasTestScript) {
		...
		console.log(
			`    The gate will still work — add a "test" script later for full coverage.\n`,
		);
	}
	...
	console.log("");
	console.log(
		"    npx evalai doctor             Verify your setup is complete",
	);
	console.log("");
	...
	console.log(
		"    npx evalai doctor             Preflight check — verify config, baseline, CI",
	);
	console.log("    npx evalai gate               Run regression gate locally");
	console.log(
		"    npx evalai check              API-based gate (requires account)",
	);
	console.log(
		"    npx evalai explain            Explain last failure with root causes + fixes",
	);
	console.log(
