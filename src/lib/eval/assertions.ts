...
export function parseAssertionsJson(val: unknown): AssertionsEnvelope | LegacyAssertions | null {
...
export function validateAssertionsEnvelope(envelope: AssertionsEnvelope): AssertionsEnvelope {
