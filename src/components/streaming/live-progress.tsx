...
export function LiveProgress({
  ...
  const getTestCaseIcon = (status: string) => {
    switch (status) {
      case 'running': return <Activity className="h-3 w-3 animate-pulse text-blue-500" />;
      ...
      <CardContent className={cn("space-y-4", compact && "space-y-2")}>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between text-xs text-gray-500">
            <span>{progress?.completedTests || 0} / {progress?.totalTests || 0} tests</span>
        ...
        {/* Status Badges */}
        <div className="flex items-center gap-2">
          <Badge variant={progress?.passedTests === progress?.completedTests ? 'default' : 'secondary'}>
