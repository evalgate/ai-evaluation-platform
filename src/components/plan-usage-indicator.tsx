					...
					<div className="space-y-2">
						...
						{!tracesFeature.unlimited && (
							<>
								<Progress
									value={
										((tracesFeature.usage || 0) /
											(tracesFeature.included_usage || 1)) *
										100
									}
									className="h-2"
								/>
								<p className="text-xs text-muted-foreground">
									{(tracesFeature.balance || 0).toLocaleString()} traces
					...
					<div className="space-y-2">
						...
						{!projectsFeature.unlimited && (
							<>
								<Progress
									value={
										((projectsFeature.usage || 0) /
											(projectsFeature.included_usage || 1)) *
										100
									}
									className="h-2"
								/>
								<p className="text-xs text-muted-foreground">
									{projectsFeature.balance}{" "}
									{projectsFeature.balance === 1 ? "project" : "projects"}{" "}
									available
								</p>
							</>
						)}
