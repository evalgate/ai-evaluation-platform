        ...
        {!analysis && !loading && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-zinc-500 mb-4">
              Analyze this run to identify failure patterns and get AI-powered fix suggestions.
            </p>
          ...
          <>
              ...
              <Card className="bg-zinc-900/50 border-zinc-800">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm flex items-center gap-2">
                    <AlertTriangle className="h-4 w-4 text-orange-500" /> Failure Patterns
                  </CardTitle>
                </CardHeader>
            ...
            {analysis.rootCauses.length > 0 && (
              <Card className="bg-zinc-900/50 border-zinc-800">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm flex items-center gap-2">
                    <ChevronRight className="h-4 w-4 text-blue-500" /> Root Causes
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            {analysis.suggestedFixes.length > 0 && (
              <Card className="bg-zinc-900/50 border-zinc-800">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm flex items-center gap-2">
                    <Lightbulb className="h-4 w-4 text-yellow-500" /> Suggested Fixes
                  </CardTitle>
                </CardHeader>
            ...
            {/* Re-run button */}
            <Button onClick={runAnalysis} variant="outline" className="w-full text-xs">
