...
export function ArenaLeaderboard({ organizationId, className }: ArenaLeaderboardProps) {
          ...
          <TabsContent value="leaderboard" className="space-y-4">
                ...
                >
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      <div className={cn("text-lg font-bold", getWinRateColor(entry.winRate))}>
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-1">
                        ...
                        <span className={cn("font-medium", getStreakColor(entry.streak))}>
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-1 text-sm">
                        ...
                        <span>{(entry.averageResponseTime / 1000).toFixed(1)}s</span>
                      </div>
            ...
            {leaderboard.length === 0 && (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">Start some battles to see the leaderboard!</p>
              </div>
            )}
          </TabsContent>
                  ...
                  <div key={entry.modelId} className="space-y-2">
                    ...
                    <div className="grid grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <span className="font-medium ml-1">{entry.averageScore.toFixed(0)}</span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="font-medium ml-1">${entry.totalCost.toFixed(2)}</span>
                      </div>
                      <div>
