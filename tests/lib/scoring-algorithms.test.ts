...
describe("ScoringAlgorithms", () => {
	describe("cosineSimilarity", () => {
		it("identical text → score 100", () => {
			const r = ScoringAlgorithms.cosineSimilarity(
				"the quick brown fox",
				"the quick brown fox",
			);
		...
		it("empty input → score 0, no throw", () => {
			expect(() =>
				ScoringAlgorithms.cosineSimilarity("", "hello"),
			).not.toThrow();
	...
	describe("levenshteinDistance", () => {
		...
		it("empty input → score 0, no throw", () => {
			expect(() =>
				ScoringAlgorithms.levenshteinDistance("", "hello"),
			).not.toThrow();
	...
	describe("jaccardSimilarity", () => {
		it("identical text → score 100", () => {
			const r = ScoringAlgorithms.jaccardSimilarity(
				"the cat sat",
				"the cat sat",
			);
			expect(r.score).toBe(100);
		...
		it("empty input → score 0, no throw", () => {
			expect(() =>
				ScoringAlgorithms.jaccardSimilarity("", "hello"),
			).not.toThrow();
	...
	describe("bleuScore", () => {
		it("identical text → score 100", () => {
			const r = ScoringAlgorithms.bleuScore(
				"the quick brown fox",
				"the quick brown fox",
			);
			expect(r.score).toBe(100);
	...
	describe("batchScore", () => {
		...
		it("respects algorithm option", () => {
			...
			const r = ScoringAlgorithms.batchScore(pairs, {
