...
import { createModuleLogger, logger } from "@/lib/logger";
...
describe("Logger", () => {
	...
	it("should log info messages", () => {
		...
		const logOutput = (console.log as unknown as ReturnType<typeof vi.fn>).mock
			.calls[0][0];
	...
	it("should log errors with stack traces", () => {
		...
		const logOutput = (console.error as unknown as ReturnType<typeof vi.fn>)
			.mock.calls[0][0];
	...
	it("should log warnings", () => {
		...
		const logOutput = (console.warn as unknown as ReturnType<typeof vi.fn>).mock
			.calls[0][0];
