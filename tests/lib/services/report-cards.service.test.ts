  ...
  describe("generateReportCardSummary", () => {
    it("calculates overall score and grade correctly", async () => {
      ...
      state.updateQueue = [
        ...
        [{ id: 1, evaluationRunId: 101, score: 95, status: "passed", durationMs: 100 }], // test results
        [{ id: 1, evaluationRunId: 101, score: 90, metadata: '{"passed": true}' }], // judge results
      ];
    ...
    it("assigns lower grades for poorer performance", async () => {
      state.updateQueue = [
        ...
        [{ id: 1, name: "Test Org" }], // organization
        [{ id: 101, status: "completed", createdAt: "2024-01-01" }], // runs
        [{ id: 1, evaluationRunId: 101, score: 40, status: "failed", durationMs: 100 }], // test results
        [{ id: 1, evaluationRunId: 101, score: 30, metadata: '{"passed": false}' }], // judge results
      ];
