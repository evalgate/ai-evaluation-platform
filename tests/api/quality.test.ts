	...
	describe("GET", () => {
		it("should return latest quality score with evaluationId", async () => {
			const req = new NextRequest(
				"http://localhost:3000/api/quality?evaluationId=1&action=latest",
			);
		...
		it("should return trend with evaluationId", async () => {
			const req = new NextRequest(
				"http://localhost:3000/api/quality?evaluationId=1&action=trend",
			);
		...
		it("should return 400 when evaluationId is missing", async () => {
			const req = new NextRequest(
				"http://localhost:3000/api/quality?action=latest",
			);
