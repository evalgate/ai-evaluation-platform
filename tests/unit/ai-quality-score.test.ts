...
describe("generateShareableLink", () => {
  ...
  it("should generate correct shareable link", () => {
    ...
    expect(link).toBe("https://v0-ai-evaluation-platform-nu.vercel.app/share/123/456");
  });

  it("should handle different organization and evaluation IDs", () => {
    const link = generateShareableLink(999, 888);
    expect(link).toBe("https://v0-ai-evaluation-platform-nu.vercel.app/share/999/888");
  });

  it("should handle zero IDs", () => {
    const link = generateShareableLink(0, 0);
    expect(link).toBe("https://v0-ai-evaluation-platform-nu.vercel.app/share/0/0");
  });
  ...
  it("should handle large IDs", () => {
    ...
    expect(link).toBe("https://v0-ai-evaluation-platform-nu.vercel.app/share/999999/888888");
  });
});
